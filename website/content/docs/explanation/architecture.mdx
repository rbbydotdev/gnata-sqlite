...
**Why TinyGo?** Standard Go WASM: ~5.3 MB. TinyGo: 126 KB (42x smaller). For a module that loads on every page visit, that is the difference between instant and a loading spinner.
...
4. LSP in browsers → TinyGo WASM (126 KB)
